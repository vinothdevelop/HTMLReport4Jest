...
describe('Expand result tab heading test', () => {
    test('Should be expanded when expandResults is true', () => {
        let item = { title: "Test parent", id: "1", children: [{ title: "Test child", id: "2" }] }
        const { container } = render(
            <TabHeading expandResults={true} item={item} onShowModel={function () { }}>
            </TabHeading>
        );
        expect(container.firstChild.firstChild.checked).toBe(true);
        expect(window.getComputedStyle(container.firstChild.lastChild).display).toEqual('block');
    });
    ...
    test('Should be collapsed when expandResults is false', () => {
        let item = { title: "Test parent", id: "1", children: [{ title: "Test child", id: "2" }] }
        const { container } = render(
            <TabHeading expandResults={false} item={item} onShowModel={function () { }}>
            </TabHeading>
        )
        expect(container.firstChild.firstChild.checked).toBe(false);
    });
    ...
    test('Should be collapsed when expandResults is null', () => {
        let item = { title: "Test parent", id: "1", children: [{ title: "Test child", id: "2" }] }
        const { container } = render(
            <TabHeading expandResults={null} item={item} onShowModel={function () { }}>
            </TabHeading>
        );
        expect(container.firstChild.firstChild.checked).toBe(false);
    });
    ...
    test('Should be collapsed when expandResults is undefined', () => {
        let item = { title: "Test parent", id: "1", children: [{ title: "Test child", id: "2" }] }
        const { container } = render(
            <TabHeading expandResults={undefined} item={item} onShowModel={function () { }}>
            </TabHeading>
        );
        expect(container.firstChild.firstChild.checked).toBe(false);
    });
